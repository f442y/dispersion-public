...
public interface Transition<CTX extends StateMachineContext<CTX>> {
     ...
     */
    static <CTX extends StateMachineContext<CTX>> Transition<CTX> Become(
            StateMachineStateConfiguration<CTX> nextStateMachineStateConfiguration
    ) {
     ...
     */
    StateMachineStateConfiguration<CTX> applyToStateConfig(
            StateMachineStateConfiguration<CTX> originalStateMachineStateConfiguration
    );
}
