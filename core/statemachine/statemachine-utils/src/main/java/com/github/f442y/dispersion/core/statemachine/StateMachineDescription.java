...
//                    ActionDependencies<?, ?, ?> actionDependencies = stateConfiguration.action.getDependencies();
...
//                        new StateMachineDescriptionAdjacencyListJson.State(
//                                stateConfiguration.toString(),
...
//                                        .map(sc -> new StateMachineDescriptionAdjacencyListJson.Transition(
//                                                sc
//                                                        .getClass()
//                                                        .toString(),
...
//            }
//        });
//        StateMachineDescriptionAdjacencyListJson sss = new StateMachineDescriptionAdjacencyListJson(
//                "statemachine",
